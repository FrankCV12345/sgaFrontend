<template>
    <v-layout>
        <v-flex sm12>
            ...
            <h1>Agregar Curso</h1>
            <v-text-field v-model="curso.nombrecurso" :counter="30" label="Nombre Curso" maxlength="30" required></v-text-field>
            <v-text-field v-model="curso.descripioncurso" :counter="120" label="Descripcion Curso" required maxlength="120"></v-text-field>
            <v-btn
                color="primary"
                @click="registraCuro()"
            >
